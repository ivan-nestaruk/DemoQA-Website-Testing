Feature: Checking the "Practice Form" submodule of the Forms module
    ...
    Scenario: 03. As a user, I can fill in, submit, and verify the Student Registration Form
        ...
        And I should verify that output contains: "John"
        And I should verify that output contains: "Doe"
        And I should verify that output contains: "test12345@yopmail.com"
        And I should verify that output contains: "Male"
        And I should verify that output contains: "7777777777"
        And I should verify that output contains: "01 February,2022"
        And I should verify that output contains: "Maths"
        And I should verify that output contains: "Sports"
        And I should verify that output contains: "picture.png"
        And I should verify that output contains: "221B Baker Street, London"
        And I should verify that output contains: "Haryana"
        And I should verify that output contains: "Panipat"